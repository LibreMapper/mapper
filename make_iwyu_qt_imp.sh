...
echo "# --- Generated by ${0##*/} ---"
LAST_MODULE=""
for MODULE in QtAndroidExtras QtConcurrent QtCore QtCore5Compat QtGui QtNetwork QtPositioning QtPrintSupport QtSensors QtSerialPort QtTest QtWidgets
do
	echo -e "\n    # ${MODULE}"
	...
	done | sed 's;[[:space:]]*// IWYU pragma:[[:alpha:][:space:],]*$;;' | sort
done # module
